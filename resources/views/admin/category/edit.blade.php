	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="update_data" role="form" method="post" action="{{ URL::route('admin.category_update') }}">
			...
			<div class="modal-footer">
					<button type="button" id="update_category_button" class="btn btn-info"{{-- data-dismiss="modal" --}}>Update Category</button>
				</form>
			</div>
		</div>
	</div>
